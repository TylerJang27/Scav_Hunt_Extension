...
export const wrapDecrypt = (text: string | undefined, encoded: boolean, secretKey: string) => {
    if (text) {
...
export const wrapEncrypt = (text: string | undefined, encoded: boolean, secretKey: string) => {
    if (text) {
